...
- **convergent**: Refine and combine. Take existing ideas and find novel combinations, variations, and improvements.
- **wild**: No constraints. Ignore feasibility, budget, time. What would you do with infinite resources?

## Process

1. Understand the problem/opportunity space
2. Generate ideas in waves (don't stop at the first good one)
3. Push past the obvious - the best ideas often come after the first 10
...
4. **Video Diary from Past Onboarders**: Real struggles and "aha" moments from recent hires
...
9. **"Why Does This Exist?" Button**: Click any file/function to see its history and purpose
...
- IDEATION-ONLY: no code, no architecture, no plans
- Quantity first: more ideas = better ideas emerge
- No judgment: feasibility is someone else's job
- Cross-pollinate: steal from other domains liberally
- Push past obvious: first ideas are rarely best ideas
- Embrace weird: the unusual ideas are often most valuable
