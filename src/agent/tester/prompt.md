...
Use async delegation for parallel test file discovery when analyzing multiple test suites.

{{protocol:async-delegation}}

**Key point for testers**: Use async for parallel explorer calls when discovering test patterns across different modules or finding related test files.
